...
# HEADER
# ------------------------------------------------------
st.markdown("<h1>Top Curated SQL Repos for Data Engineers</h1>", unsafe_allow_html=True)
st.markdown(
    '<div class="subtitle">One stop destination to browse all SQL repos for data geeks.</div>',
    unsafe_allow_html=True
)
